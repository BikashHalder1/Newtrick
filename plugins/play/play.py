...
from Bikash.config import BANNED_USERS, LOG_GROUP_ID, OWNER_ID, lyrical
from Bikash import LOGGER, Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
from Bikash.utils.database import add_served_chat, get_assistant, is_video_allowed
...
from Bikash.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
        ...
        if await YouTube.exists(url):
            ...
            if "album" in url:
                ...
                await app.send_message(
                    OWNER_ID[0],
                    f"**ʜᴇʏ [BIKASHٖ](tg://user?id={OWNER_ID[0]}) ᴍᴀʏ ʙᴇ ᴍʏ ᴄᴏᴏᴋɪᴇs ʜᴀs ʙᴇᴇɴ ᴅᴇᴀᴅ ᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ᴏɴᴇ ᴛɪᴍᴇ ʙʏ ᴘʟᴀʏ ᴀɴʏ sᴏɴɢs**",
                )
